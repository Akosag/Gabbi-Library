...
if (isset($_POST['add'])) {
    ...
    $aveliable = $_POST['aveliable'];
	  $year = $_POST['year'];
        ...
        if ($stmt->execute()) {
            $add_user_success = "Book added successfully.";
        } else {
...
$sql1="update gabilms.books set title='$title', author='$author', available='$available', isbn='$isbn', year='$year', quantity='$quantity' where book_id='$book_id'";
		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					...
					<button class="btn btn-outline-primary shadow-none me-lg-2 me-3" data-bs-toggle="modal" data-bs-target="#registerModal"><i class="fa fa-plus"></i> Add Book</button>
				</large>
          ...
          Note: You must fill all details.
            ...
            <div class="container-fluid">
              <div class="row">
				...
				<div class="col-md-6 ps-0 mb-3">
                <label for="reg_available">Available:</label>
                <input type="number" name="available" id="reg_available" required class="form-control shadow-none"><br>
                </div>

				<div class="col-md-6 ps-0 mb-3">
                <label for="reg_available">Year:</label>
                <input type="number" name="year" id="reg_available" required class="form-control shadow-none"><br>
                </div>

...
$sql1="update gabilms.users set fullname='$fullname', username='$username', password='$password', email='$email', Category='$Category', role='$role' where user_id='$user_id'";
...
if ($result->num_rows > 0) {
    ...
    echo "<tr><th class='text-center'>Username</th><th class='text-center'>Fullname</th><th class='text-center'>Email</th><th class='text-center'>Role</th><th class='text-center'>Role No</th><th class='text-center'>Action</th></tr>"; // Table headers
    while($row = $result->fetch_assoc()) {

        echo "<tr><td class='text-center'>" . $row["username"]. "</td><td class='text-center'>" . $row["fullname"]. "</td><td class='text-center'>" . $row["email"]. "</td><td class='text-center'>" . $row["role"]. "</td><td class='text-center'>" . $row["RollNo"]. "</td>";

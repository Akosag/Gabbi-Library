                    ...
                    <div class="container">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select return.BookId,return.RollNo,Title,datediff(curdate(),Due_Date) as x from GABILMS.return,GABILMS.books,GABILMS.record where return.BookId=books.book_id and return.BookId=record.book_id and return.RollNo=record.RollNo";
...
$sql1="update GABILMS.record set Date_of_Return=curdate(),Dues='$dues' where book_id='$bookid' and RollNo='$rollno'";
 
if($conn->query($sql1) === TRUE)
{$sql3="update GABILMS.books set Available=Available+1 where book_id='$bookid'";
 $result=$conn->query($sql3);
 $sql4="delete from GABILMS.return where BookId='$bookid' and RollNo='$rollno'";
 $result=$conn->query($sql4);
 $sql6="delete from GABILMS.renew where BookId='$bookid' and RollNo='$rollno'";
 $result=$conn->query($sql6);
 $sql5="insert into GABILMS.message (RollNo,Msg,Date,Time) values ('$rollno','Your request for return of BookId: $bookid  has been accepted',curdate(),curtime())";

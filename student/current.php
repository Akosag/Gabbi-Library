                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from GABILMS.record,GABILMS.books where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and books.book_id = record.book_id and (record.book_id='$s' or Title like '%$s%')";

                                        }
                                    else
                                        $sql="select * from GABILMS.record,GABILMS.books where RollNo = '$rollno' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and books.book_id = record.book_id";
